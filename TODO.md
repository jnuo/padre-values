...
- [x] Save latest sorting method, by updating the backend - in this case that is changing the google sheet column orderings. Later when we have a DB, this can turn into another DB update for saving user preferences.
